...
The Vite and webpack plugins take the same options. Everything here is a **project** decision, set
in code — the toolbar's own settings panel is for per-developer preferences instead.
